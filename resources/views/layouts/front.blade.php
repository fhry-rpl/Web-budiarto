...
<head>
    ...
    <meta property="og:description" content="@yield('og_description', 'Website resmi RENPRO UPBU Budiarto')">
    ...
    <meta name="twitter:description" content="@yield('twitter_description', 'Website resmi RENPRO UPBU Budiarto')">
...
@php
    $schema = [
        ...
        'description' => 'Website resmi RENPRO UPBU Budiarto',
        'contactPoint' => [
            '@type' => 'ContactPoint',
